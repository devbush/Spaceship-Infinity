...
#endif
#ifndef DEFAULT_LIVES
  #define DEFAULT_LIVES 1
#endif
#ifndef DEFAULT_LASERTIME
  #define DEFAULT_LASERTIME 3
#endif
////////////////////////////////////////////////////////////////////////////////
// types
////////////////////////////////////////////////////////////////////////////////
...
static const struct option options[] =
{
  ...
  [OPTION_TAIL] = { "tail", no_argument, 0, 0, },
  [OPTION_FRIENDLY] = { "friendly", no_argument, 0, 0, },
  [OPTION_LIVES] = { "lives", required_argument, 0, 0, },
  [OPTION_LASERTIME] = { "laser", required_argument, 0, 0, },
...
void print_help(FILE* const stream, const char* const program)
{
  ...
  fprintf(stream, "  --tail                    Add the tail's hitbox.\n");
  fprintf(stream, "  --friendly                Add friendly fire.\n");
  fprintf(stream, "  --lives=<value>           Set amount of starting lives.\n");
  fprintf(stream, "  --laser=<value>           Set laser's duration in seconds.\n");
}
    ...
    spaceship_options* const o, const int option_index, const char* const arg)
{
  switch (option_index)
  {
    ...
    case OPTION_TAIL:
      o->tail = true;
      break;
    case OPTION_FRIENDLY:
      o->friendly = true;
      break;
    case OPTION_LIVES:
      o->lives = atoi(arg);
      o->lives = o->lives > 9 ? 9 : o->lives;
      o->lives = o->lives < 1 ? 1 : o->lives;
      break;
    case OPTION_LASERTIME:
      o->laserTime = atoi(arg);
      o->laserTime = o->laserTime > 9 ? 9 : o->laserTime;
      o->laserTime = o->laserTime < 1 ? 1 : o->laserTime;
      break;
    default:
      break;
  }
